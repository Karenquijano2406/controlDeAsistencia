...
<div class="page-content">
    ...
    <div class="text-right mb-2">
      <a href="fpdf/reporteEmpleado.php" target="_blank" class="btn btn-success"><i class="fas fa-file-pdf"></i>Generar reporte</a>
    </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <!-- El boton para modificar datos del empleado no funciona -->
        <!-- <a href="" data-toggle="modal" data-target="#exampleModal<?= $datos->id_empleado?>" class="btn btn-warning btn-sn"><i class="fa-solid fa-pen-to-square"></i></a> -->
        <a href="empleado.php?id=<?= $datos->id_empleado?>" onclick="advertencia(event)"><i class=" btn btn-danger fa-solid fa-trash"></i></a>
      </td>
    ...
    <div class="modal-content">
      ...
      <form action="" method="POST">
        <div hidden class="fl-flex-label mb-4 px-2 col-12 ">
          <input type="text" placeholder="ID" class="input input_ _text" name="txtid" value="<?= $datos->id_empleado?>">
        </div>
        <div class="fl-flex-label mb-4 px-2 col-12 ">
          <input type="text" placeholder="Nombre" class="input input_ _text" name="txtnombre" value="<?= $datos->nombre?>">
        </div>
        <div class="fl-flex-label mb-4 px-2 col-12">
          <input type="text" placeholder="Apellido" class="input input_ _text" name="txtapellido" value="<?= $datos->apellido?>">
        </div>
        <div class="fl-flex-label mb-4 px-2 col-12">
          <select name="txtcargo" class="input input-select">
            <?php
