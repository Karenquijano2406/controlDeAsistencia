...
<div class="page-content">
    ...
    <div class="text-right mb-2">
      <a href="fpdf/reporteCargo.php" target="_blank" class="btn btn-success"><i class="fas fa-file-pdf"></i>Generar reporte</a>
    </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="cargo.php?id=<?= $datos->id_cargo?>" onclick="advertencia(event)"><i class=" btn btn-danger fa-solid fa-trash"></i></a>
      </td>
    ...
    <div class="modal-content">
      ...
      <form action="" method="POST">
        <div hidden class="fl-flex-label mb-4 px-2 col-12 ">
          <input type="text" placeholder="ID" class="input input_ _text" name="txtid" value="<?= $datos->id_cargo?>">
        </div>
